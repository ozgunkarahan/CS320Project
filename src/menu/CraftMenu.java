...
public class CraftMenu {
	...
	public static boolean checkMaterials(User player, int index){ // check for sufficient mats
		if(player.inventory[index] >=4) {
			return true;
		}
		else {
	...
	public static String getCraftInput(User player) {	//get input from user
		...
		while(check) {
			...
			if(input.equals("sword")  ||input.equals("armor")||input.equals("shield")||input.equals("staff")) 
				break;	
				else 
